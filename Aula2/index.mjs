...
// Instalar e importar o express
import express from 'express'
import path from 'path'

//Comando do path para acessar a pasta atual
const pastaAtual = process.cwd()
const pastaTemplate = path.join(pastaAtual,'templates')
console.log(pastaTemplate)

// inicialização do aplicativo express
const app = express()
// Criação de uma porta do servidor
const porta = 5000

// Comando para transformar os dados vindos de formulários para objetos javascript
app.use(express.urlencoded({extended:true}))
app.use(express.json())

// rota raiz
app.get('/',(req,res) => {
    res.sendFile(`${pastaTemplate}/index.html`)
})
